...
flags.defineString('access_key_id', process.env['AWS_ACCESS_KEY_ID'], 'Your AWS access key ID.')
flags.defineString('secret_access_key', process.env['AWS_SECRET_ACCESS_KEY'], 'Your AWS secret access key.')
flags.defineString('session_token', process.env['AWS_SESSION_TOKEN'], 'Your AWS session token.')
...
function createOptions() {
  ...
  if (flags.get('session_token')) options.sessionToken = flags.get('session_token')
  if (flags.get('region')) options.region = flags.get('region')
