 ...
 */
function MessageStore(outDir, filenamePattern, flushFreqSec) {
  this.logger.info('Writing messages in', flushFreqSec, 'second batches')

  this._outDir = outDir
  this._filenameGenerator = new FilenameGenerator(filenamePattern)
...
MessageStore.prototype.newFilename = function () {
  return moment().format(this._pattern)
}
 ...
 * @param {Function} done Function to call when handling is complete
 */
MessageStore.prototype.handleMessages = function (messages, done) {
